...
public class Lease {
	...
	public String toString() {
		return "leaseId=" + this.leaseId + ", tenant=" + this.tenant + ", leaseStartDate="
				+ this.leaseStartDate + ", leaseEndDate=" + this.leaseEndDate + ", monthlyRent=" + this.monthlyRent + ", leaseTerm="
